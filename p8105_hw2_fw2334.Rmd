...
The `Mr. Trash Wheel` dataset has `r nrow(trash_data)` observations, and the merged `precipitation` dataset has `r nrow(precip_data)` observations.
The total amount of precipitation in 2018 was `r sum(pull(precip_2018, total))` inches, and the median number of sports balls in a dumpster in 2017 was `r median(pull(trash_data, sports_balls))`. 
